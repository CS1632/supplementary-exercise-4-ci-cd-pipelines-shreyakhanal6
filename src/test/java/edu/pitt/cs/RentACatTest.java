...
public class RentACatTest {
	...
	public void testGetCatNullNumCats0() {
		assertNull("r.getCat(2) returns a cat when there are no cats", r.getCat(2));
	}
	...
	public void testGetCatNumCats3() {
		...
		r.addCat(c3);
		Cat ret = r.getCat(2);
		assertNotNull("getCat(2) returns NULL", ret);
		assertEquals("getCat(2) returns NULL", 2, ret.getId());
	}
	...
	public void testCatAvailableTrueNumCats3() {
		...
		r.addCat(c3);
		r.rentCat(3);
		assertTrue("catAvailable(2) returns false when cat 2 is not rented", r.catAvailable(2));
	}
	...
	public void testCatAvailableFalseNumCats3() {
		...
		assertFalse("catAvailable(2) returns true when cat 2 is rented", r.catAvailable(2));
	}
	...
	public void testCatExistsFalseNumCats0() {
		assertFalse("catExists(2) returns true when r has no cats", r.catExists(2));
	}
	...
	public void testCatExistsTrueNumCats3() {
		...
		r.addCat(c2);
		r.addCat(c3);
		assertTrue("catExists(2) returns false when r has cat 2", r.catExists(2));
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		r.addCat(c3);
		Mockito.when(c2.getRented()).thenReturn(true);
		assertFalse("rentCat(2) returns true when cat 2 is already rented", r.rentCat(2));
	...
	public void testReturnCatFailureNumCats0() {
		assertFalse("returnCat(2) returns true when r has no cats", r.returnCat(2));
	}
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue("returnCat(2) fails when cat 2 is rented", b);
